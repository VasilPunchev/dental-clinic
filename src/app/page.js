...
const services = [
  ...
  {
    title: "Дигитално сканиране",
    description:
      "Модерна апаратура за сканиране на захапката и взимане на прецизен дигитален отпечатък, по който се изработват индивидуални алайнери, съобразени с конкретния пациент.",
    icon: "🖥️",
  },
  {
  ...
  {
    title: "Лечение на кариеси и усложнения",
    description:
      "Диагностика и лечение на кариеси, пулпити и усложнения, засягащи твърдите зъбни тъкани и зъбната пулпа.",
    icon: "🛡️",
  },
